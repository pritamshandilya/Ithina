...
function AiModifyPanel({ resetKey }: AiModifyPanelProps) {
  ...
  return (
    <div className="relative flex w-64 shrink-0 flex-col overflow-hidden border-l border-ithina-border bg-ithina-bg/20">
      ...
      <div className="flex shrink-0 items-center gap-2 border-b border-ithina-border/60 px-3 py-2.5">
        ...
        {/* History button — only shown when more than 1 session exists */}
        {hasHistory && (
          <button
            type="button"
      ...
      {/* Active session indicator pill (when multiple sessions exist) */}
      {hasHistory && (

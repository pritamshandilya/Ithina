...
export function InlineEdit({
  ...
  return (
    <button
      ...
      className={cn(
        "hover:bg-muted/50 focus:ring-ring w-full min-w-0 cursor-text rounded px-1 py-0.5 text-left text-white focus:ring-2 focus:ring-offset-1 focus:outline-none",

...
export function StoreOnboardingTeamStep({
  ...
  return (
    <Card className="border-border/60 bg-card/70 glassmorphism shadow-xl">
      <CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        {!hasStore ? (
          ...
          <>
            ...
            <div className="border-border bg-background/30 overflow-hidden rounded-lg border">
              <div className="max-h-[420px] overflow-auto">
                <table className="w-full text-sm">
                  <thead className="bg-muted/70 text-muted-foreground sticky top-0 z-10 backdrop-blur-sm">
                    <tr>
                    ...
                    {filteredUsers.length === 0 ? (
                      ...
                      filteredUsers.map((user) => {
                        ...
                        return (
                          <tr
                            key={user.id}
                            className={`border-border/70 border-t transition-colors ${

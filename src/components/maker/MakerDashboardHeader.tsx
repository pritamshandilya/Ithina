 ...
 */
export function MakerDashboardHeader({ className }: MakerDashboardHeaderProps) {
          ...
          {AUDIT_MODES.map((mode) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-muted-foreground pl-6 font-mono text-[10px] tracking-[0.14em] uppercase">
                  {mode.description}
                </span>
              </DropdownMenuItem>
            );

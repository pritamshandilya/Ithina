...
function AuditActivityBarChart({ data }: { data: MakerDailyAuditCount[] }) {
  ...
  const yScale = (v: number) => PADDING.top + plotH - (plotH * v) / maxVal;
  ...
  return (
    <svg
      ...
      className="h-[220px] min-h-[200px] w-full max-w-[420px]"
      role="img"
    ...
    >
      ...
      <desc id="audit-chart-desc">
        Bar chart showing submitted and approved audit counts per day. X-axis:
        Day of week. Y-axis: Number of audits.
      </desc>
 ...
 */
export function MakerPerformanceCharts({
  className,
}: MakerPerformanceChartsProps) {
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="border-border bg-card rounded-xl border p-5">
          <div className="mb-3 flex items-center gap-2">
            <BarChart3 className="text-accent size-4 shrink-0" aria-hidden />
          ...
          <div className="text-muted-foreground mt-3 flex gap-6 text-sm">
            <span className="flex items-center gap-1.5">
              <span className="bg-chart-2 size-2.5 rounded-sm" aria-hidden />
              Submitted
            </span>
            <span className="flex items-center gap-1.5">
        ...
        <div className="border-border bg-card rounded-xl border p-5">
          <div className="mb-3 flex items-center gap-2">
            <PieChart className="text-accent size-4 shrink-0" aria-hidden />
            <h3 className="text-foreground text-sm font-semibold">

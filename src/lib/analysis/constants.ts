...
export const PIPELINE_STEPS: PipelineStepDef[] = [
  {
    ...
    sub: "YOLOv8 + SAHI identify items",
    icon: Box,
  },
  {
    id: "rows",
    label: "Shelf Rows",
    sub: "Deep Hough detects row boundaries",
    icon: Rows3,
  },
  {
    id: "recogn",
    label: "Recognition",
    sub: "CLIP embeddings match products",
    icon: Database,
  },
  {
    id: "input",
    label: "Data Enrichment",
    sub: "User input refines matches",
    icon: PenLine,
  },
  {
    id: "mapping",
    label: "Geometric Mapping",
    sub: "Logic maps layout & positions",
    icon: GitBranch,
  },
  {
    id: "report",
    label: "Compliance Report",
    sub: "Planogram engine generates results",
    icon: FileText,
  },
];

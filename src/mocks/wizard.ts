...
export const MOCK_STAGED_SKUS: StagedSku[] = [
  { sku: "SUSHI-019A", name: "Premium Salmon Tray", current: 12.99, proposed: 10.39, safe: true, discount: 20, included: true },
  { sku: "SUSHI-048B", name: "Spicy Tuna Roll 12pc", current: 14.49, proposed: 11.59, safe: true, discount: 20, included: true },
  { sku: "SUSHI-099C", name: "Dragon Roll Combo", current: 16.99, proposed: 13.59, safe: false, margin: "14%", discount: 20, included: true },
];

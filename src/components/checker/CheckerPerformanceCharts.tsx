...
function ComplianceTrendBarChart({ data }: { data: CheckerDailyCompliance[] }) {
  const maxScore = 100;
  ...
  return (
    ...
    >
      ...
      <desc id="compliance-chart-desc">
        Bar chart showing average compliance score and approved audits per day.
        X-axis: Day of week. Y-axis: Score (0-100) and count.
      </desc>

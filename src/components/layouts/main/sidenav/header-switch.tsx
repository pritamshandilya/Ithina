            ...
            <SidebarMenuItem>
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        ...
                        >
                            <div className="flex aspect-square size-8 items-center justify-center rounded-lg bg-accent text-accent-foreground shrink-0 group-data-[collapsible=icon]:mx-auto">
                    ...
                    >
                        ...
                        >
                            <div className="flex size-6 items-center justify-center rounded-sm border border-border/50 bg-background/50">

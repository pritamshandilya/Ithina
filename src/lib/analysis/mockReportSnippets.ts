  ...
  issueCategories: [
    {
      ...
      count: 2,
      description:
        "Products placed on the wrong shelf or in the wrong position.",
      variant: "misplaced",
    },
    {
      id: "missing",
      ...
      count: 8,
      description:
        "Products defined in the planogram but not detected on the shelf.",
      variant: "missing",
    },
    {
      id: "extra",
      ...
      count: 79,
      description:
        "Products detected on the shelf that are not part of the planogram.",
      variant: "extra",
    },
    {
      id: "depth",
      ...
      count: 3,
      description:
        "Products where front facings match but depth stock needs manual verification.",
      variant: "depth",
    },
    {
      id: "analysis",
      ...
      count: 5,
      description:
        "Empty shelf spaces, out of stock gaps, or low-margin product placement.",
      variant: "analysis",
    },
  ],
  ...
  issuesToReview: [
    {
      ...
      description: "0/6 facings detected — missing",
      type: "Missing",
    },
    {
      skuName: "Water Bottle 1L",
      description: "0/3 facings detected — missing",
      type: "Missing",
    },
    {
      skuName: "Yellow Pasta Box",
      description: "Misplaced — expected shelf 4, found on shelf 1",
      type: "Misplaced",
    },
    {
      skuName: "Shelf 2",
      description: "Empty space detected",
      type: "Empty Space",
    },
    {
      skuName: "Black Pasta Box",
      description: "Low margin in prime position",
      type: "Analysis",
    },
  ],
};

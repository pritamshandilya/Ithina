...
interface ScheduleStepProps {
  onNext: () => void;
  onScheduleChange?: (schedule: { dateLabel: string; timeLabel: string }) => void;
}
...
export default function ScheduleStep({ onNext, onScheduleChange }: ScheduleStepProps) {
  ...
  const scheduleDateLabel = startDate
    ...
    : "Immediate";
  const scheduleTimeLabel = startTime
  ...
  }, [onScheduleChange, scheduleDateLabel, scheduleTimeLabel]);

...
function getInitialEditShelfFormValues(shelf: Shelf): EditShelfFormValues {
  const [width = "", height = "", depth = ""] = (shelf.dimensions || "").split(
    "x",
  );
...
export function EditShelfModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose}>
      <Card className="border-border/50 bg-card/50 overflow-hidden shadow-2xl backdrop-blur-xl">
        <CardHeader className="from-accent/10 via-card to-card border-border/50 border-b bg-gradient-to-br">
          <CardTitle>Edit Shelf Details</CardTitle>
          <CardDescription>
            Update the basic identifying information for this shelf.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4 p-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-[10px] italic">
              * This is the unique string code used to identify the shelf within
              its fixture.
            </p>
          </div>
        ...
        <CardFooter className="border-border/50 bg-muted/20 flex justify-end gap-3 border-t p-6 pt-0">

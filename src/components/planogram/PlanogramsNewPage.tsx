...
export function PlanogramsNewPage() {
  ...
  const runParse = useCallback(() => {
    ...
    try {
      ...
      setPreview(null);
      setParseError(
        e instanceof Error ? e.message : "Could not parse planogram JSON.",
      );
    }
  }, [rawJson]);
  ...
  const loadSample = useCallback(() => {
    ...
    try {
      ...
      setPreview(null);
      setParseError(
        e instanceof Error ? e.message : "Could not parse sample JSON.",
      );
    }
  }, []);
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `${preview.name} is now in your library.`,
      });
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-screen-2xl space-y-4 px-2 pt-2 pb-6 sm:px-3 lg:px-4">
          ...
          <div className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  The file should follow the planogram schema (see bundled
                  sample). Parsing normalizes missing fields.
                </CardDescription>
              </CardHeader>

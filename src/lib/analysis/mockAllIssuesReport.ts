      ...
      issues: [
        {
          ...
          description:
            'Unexpected product "Yellow Pasta Bag" detected on shelf 1',
          severity: "MEDIUM",
        },
        {
          id: "ex-2",
        ...
        },
        {
          ...
          description:
            'Unexpected product "White Pasta Box" detected on shelf 4',
          severity: "MEDIUM",
        },
        {
          id: "ex-5",
          ...
          description:
            'Unexpected product "Black Pasta Box" detected on shelf 4',
          severity: "MEDIUM",
        },
        {
          id: "ex-6",
        ...
        },
        {
          ...
          description:
            'Unexpected product "Blue Pasta Box" detected on shelf 4',
          severity: "MEDIUM",
        },
        {
          id: "ex-8",
          ...
          description:
            'Unexpected product "Green Pasta Stack" detected on shelf 4',
          severity: "MEDIUM",
        },
      ],
    },
